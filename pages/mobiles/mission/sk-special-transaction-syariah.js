...
export default function MissonSyariahSpecialTransactionSK() {
        ...
        return (
            <div className="pb-4">
                <div className="p-4 mx-4 rounded-lg bg-white">
                    ...
                    <p className="py-2 pl-4 pr-1 text-xs">
                        <ol className="list-decimal">
                            <li className="py-0.5">Pengguna LinkAja dapat mengikuti Misi transaksi Jadi Berkah melalui microsite apa2bisa.linkaja.id</li>
                            <li className="py-0.5">Setiap misi pengguna dapat melakukan transaksi maksimal 2x /minggu / kategori misi</li>
                            <li className="py-0.5">Poin yang didapat pengguna tidak berlaku kelipatan, Contoh: Jika transaksi isi saldo LinkAja Syariah di atas nominal yang ditentukan, poin yang didapat tetap 150 walau nominal transaksi di atas Rp100.000 sesuai syarat.</li>
                            <li className="py-0.5">Nominal minimal transaksi & jumlah poin yang didapat berdasarkan kategori misi yang dipilih</li>
                            <li className="py-0.5">Misi transaksi Jadi Berkah mencakup kategori, sebagai berikut:
                                <ul className="py-1 px-2.5" style={{ listStyleType: 'lower-alpha' }}>
                                    <li className="py-0.5">Isi Saldo di Bank Syariah minimal transaksi Rp50.000 mendapatkan 150 poin per transaksi</li>
                                    ...
                                    <li className="py-0.5">Layanan Keuangan; BPJS & investasi reksadana minimal transaksi Rp50,000 mendapatkan 150 poin per transaksi</li>
                                    <li className="py-0.5">Merchant & Swalayan; Restoran, Kafe, Toko, Minimarket & Supermarket minimal transaksi Rp50,000 mendapatkan 150 poin per transaksi</li>
                                    <li className="py-0.5">Jalan-jalan & Delivery Makanan minimal transaksi Rp50,000 mendapatkan 150 poin per transaksi</li>
                                    <li className="py-0.5">E-commerce minimal transaksi Rp50,000 mendapatkan 150 poin per transaksi</li>
                                    <li className="py-0.5">Transportasi, Parkir minimal transaksi Rp15,000 mendapatkan 100 poin per transaksi</li>
                                    <li className="py-0.5">Zakat, Infak, Sedekah, Wakaf minimal transaksi Rp30,000 mendapatkan 100 poin per transaksi</li>
                                    <li className="py-0.5">Layanan Rumah & Kesehatan, minimal transaksi Rp50,000 mendapatkan 150 poin per transaksi</li>
                            ...
                            <li className="py-0.5">Ketentuan Hadiah Berkah sudah disesuaikan dengan prinsip syariah. Hadiah Berkah ini berasal dari biaya Promosi LinkAja dan bukan dari saldo LinkAja pengguna dengan Skema Akad Jualan.</li>
                            <li className="py-0.5">Promo ini sudah sesuai dengan prinsip syariah dan mendapatkan persetujuan Dewan Pengawas Syariah.</li>
                            <li className="py-0.5">Setiap pengguna bertanggung jawab secara pribadi atas transaksi yang dilakukan melalui aplikasi Layanan Syariah LinkAja dan hanya dipergunakan untuk transaksi yang sesuai prinsip syariah.</li>
    ...
    return (
        <Layout
            title={`Apa2Bisa - Misi Syariah Transaksi Harian Syarat & Ketentuan | LinkAja`}
            headerBack={`/mission`}
