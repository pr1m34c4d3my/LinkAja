...
export default function OAuthPage() {
  ...
  const _renderContent = () => {
    return (
      <>
        <h2 className="text-left text-2xl font-black mb-5">Daftar Sekarang</h2>
        <p className='text-left text-gray-400'>Daftar dengan Google atau Facebook untuk menikmati berbagai permainan dan reward dari LinkAja</p>
        <div className="flex flex-col pt-3 md:pt-8">
          <div className="flex flex-col pt-4">
            {/* BUTTON GOOGLE */}
            <button onClick={() => signIn()} className="flex flex-row justify-center w-full px-10 py-3 mb-2 rounded-full border border-ruby-base">
          ...
          <div className="flex flex-col pt-4">
            ...
            <FacebookLogin
              ...
              render={renderProps => (
                <button onClick={() => renderProps.onClick()} className='flex flex-row justify-center w-full px-8 py-3 mt-2 rounded-full border border-ruby-base'>
