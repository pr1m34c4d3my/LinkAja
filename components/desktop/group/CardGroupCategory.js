...
export default function CardGroupCategory({ data }) {
  return (
    <>
      <Link href={`/group/category/[id]?id=${data.id}`} as={'/group/' + data.id}>
          ...
          <div className="bg-white rounded-lg border border-gray-200 flex p-3 mb-2">
            ...
            <div className="w-9/12">
              ...
              <div className="flex items-center">
                ...
                <div className="text-xs text-gray-500">{data.post_count} Posts</div>
              </div>
            </div>
