import ProgressItem from '@/components/mobiles/dashboard/ProgressAchievement/ProgressItem'
  ...
  return (
    <div className="flex justify-between w-full">
      <div aria-label="wrapper" className="w-full overflow-hidden">
        ...
        >
          <div aria-label="progress-bar" className="flex w-full px-4">
      ...
      {/* <div className="pl-3 text-ruby-base">
      <IconQuestion color="inherit" />
    </div> */}
    </div>
  )
}